    ...
    <div>
        <Row>
            ...
            <Col s={2} className='grid-example'>
                ...
                <Button className="btn-floating btn-large waves-effect waves-light red" onClick={props.addChild}><i className="material-icons">add</i>
                </Button>
                <Button className="btn-floating btn-large waves-effect waves-light yellow" onClick={props.removeChild}><i className="material-icons">remove</i>
                </Button>
            </Col>
        </Row>
        <div>
...
const ChildComponent = props => (
    ...
    <div>
        <Row>
            ...
            <Col s={1} className='grid-example'>{colBackground}</Col>
            <Col s={1} className='grid-example'>{colBackground}</Col>
            <Col s={2} className='grid-example'>{"Ligne n°" + props.number}</Col>
        </Row>
</div>);
